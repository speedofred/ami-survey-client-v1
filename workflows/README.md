...
1. Open a **fresh** session at the repository root, meaning a new conversation in the
...
scale in one extra call, which is deliberately excluded from the telemetry, for the
